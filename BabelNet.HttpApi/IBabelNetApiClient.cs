...
namespace BabelNet.HttpApi
{
    public interface IBabelNetApiClient
    {
        ...
        Task<ICollection<ISense>> GetSensesAsync(string lemma, string searchLang);
        ...
        Task<ICollection<ISense>> GetSensesAsync(string lemma, string searchLang, string targetLang, UniversalPOS? pos = null, string? source = null);
        ...
        Task<ICollection<SynsetId>> GetSynsetIdsAsync(string lemma, string searchLang);
        Task<ICollection<SynsetId>> GetSynsetIdsAsync(string lemma, string searchLang, string targetLang, UniversalPOS? pos = null, string? source = null);
